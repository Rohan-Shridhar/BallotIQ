...
export default function HeroVisual() {
  return (
    <div className="relative w-full h-[300px] sm:h-[350px] md:h-[380px] lg:h-[400px] animate-in slide-in-from-right-8 duration-1000">
      ...
      <div className="absolute top-0 sm:-top-4 right-0 sm:-right-6 w-[188px] sm:w-[280px] p-3 sm:p-5 rounded-2xl sm:rounded-[2rem] bg-card text-card-foreground border border-border shadow-xl sm:shadow-2xl rotate-2 sm:rotate-3 hover:rotate-0 transition-all duration-500 z-20">
        <div className="flex items-center gap-2.5 sm:gap-4 mb-3 sm:mb-6">
          ...
          <div>
            <h4 className="text-foreground font-bold text-xs sm:text-sm"><TranslatedText text="Adaptive Path" /></h4>
            <p className="text-blue-600 dark:text-blue-400 text-[9px] sm:text-[10px] font-medium tracking-widest uppercase"><TranslatedText text="Level: Beginner" /></p>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-[9px] sm:text-[10px] text-muted-foreground font-medium">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[260px] sm:w-[320px] p-4 sm:p-6 rounded-2xl sm:rounded-[2.5rem] bg-white/70 dark:bg-white/[0.03] backdrop-blur-3xl border border-border shadow-xl sm:shadow-2xl z-10 flex flex-col gap-3 sm:gap-4">
        <div className="flex items-center justify-between border-b border-border pb-2 sm:pb-3">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
            <span className="text-[9px] sm:text-[10px] font-bold text-foreground uppercase tracking-widest"><TranslatedText text="BallotIQ Assistant" /></span>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex justify-start">
            <div className="max-w-[80%] p-2 sm:p-3 rounded-xl sm:rounded-2xl rounded-tl-sm bg-secondary border border-border text-[8px] sm:text-[10px] text-foreground/80 leading-relaxed">
        ...
        <div className="mt-1 sm:mt-2 h-8 sm:h-10 w-full bg-muted rounded-lg sm:rounded-xl border border-border flex items-center px-3 sm:px-4 justify-between">
          <div className="h-1 sm:h-1.5 w-16 sm:w-24 bg-muted-foreground/30 rounded-full" />
          <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-lg bg-secondary flex items-center justify-center">
